          ...
          <div className="container">
            ...
            <div className="lg:col-span-8 col-span-12">
                <div className="single-course-details">
                  ...
                  <h2 className="text-2xl mb-2">yoga </h2>
                      ...
                      <div id="tab1" className="tab-content">
                        <div>
                          ...
                          <p className="mt-4">
                            ...
                            thoroughly about the yoga 
                            
                            
                            
                            
                            <br /> <br /> you’ll develop all skills after that class.
                      ...
                      <div id="tab2" className="tab-content">
                        <div>
                          ...
                          <p className="mt-4">
                            ...
                            actually apply these abstract concepts by practise.
                          ...
                          <div>
                            <h4 className=" text-2xl">What You will Learn?</h4>
                            <p className="mt-4">you will able to perform yoga after this masterclass . I'm sure you will absolutely enjoy your time with us.</p>
                          </div>
                        </div>
                      </div>
